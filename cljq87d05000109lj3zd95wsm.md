...
Como é possível ver, de fato, a resposta é em JSON, porém, no padrão do Symfony. A seguir, iremos fazer uma classe para podermos formatar a resposta de JSON no formato que desejamos.
